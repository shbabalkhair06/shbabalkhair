                    ...
                    <div className="relative group">
                        ...
                        <div className="relative bg-white/80 backdrop-blur-xl overflow-hidden rounded-3xl shadow-2xl border border-white/50 transform transition-all duration-500 hover:shadow-3xl">
                            ...
                            <div className="relative h-80 md:h-[450px] overflow-hidden">
                                ...
                                {/* Spots Counter Badge - Enhanced with pulse */}
                                <div className="absolute top-4 left-4 md:top-6 md:left-6 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                                    <div className={`relative px-3 py-2 md:px-5 md:py-3 rounded-xl md:rounded-2xl font-bold text-white shadow-2xl backdrop-blur-md ${spotsRemaining > 0
                                        ? 'bg-gradient-to-r from-emerald-500/90 to-green-600/90'
                                        : 'bg-gradient-to-r from-red-500/90 to-rose-600/90'
                                        }`}>
                                        {spotsRemaining > 0 && (
                                            <div className="absolute inset-0 rounded-xl md:rounded-2xl bg-gradient-to-r from-emerald-400 to-green-500 animate-pulse opacity-50" />
                                        )}
                                        <span className="relative flex items-center gap-1 md:gap-2">
                                            <span className="text-xl md:text-3xl font-black">{spotsRemaining}</span>
                                            <span className="text-xs md:text-sm">{text.spotsLeft}</span>
                                            <span className="text-sm md:text-xl">👥</span>
                                        </span>
                                    </div>
                                </div>

                                {/* Date Badge - Enhanced & Mobile Optimized */}
                                <div className="absolute top-14 left-4 md:top-6 md:right-6 md:left-auto animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
                                    <div className="px-3 py-2 md:px-5 md:py-3 rounded-xl md:rounded-2xl bg-white/20 backdrop-blur-md text-white text-sm md:text-base font-semibold border border-white/30 shadow-lg">
                                        {text.date}
                                    </div>
                                </div>
